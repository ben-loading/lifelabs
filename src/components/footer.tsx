    ...
    <footer className="border-t border-border bg-muted/30" id="about">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-muted-foreground tracking-wider">{t.footer.subtitle}</span>
              </div>
            </div>
          ...
          <div>
            <h3 className="font-semibold mb-4">{t.footer.ourPhilosophy}</h3>
          ...
          <div>
            <h3 className="font-semibold mb-4">{t.footer.joinCommunity}</h3>
            <a
